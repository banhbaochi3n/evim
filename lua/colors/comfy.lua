...
local palette = {
  white   = { gui='#c0b18b', cterm=250 },
  grey    = { gui='#c0b18b', cterm=250 },
  dark    = { gui='#535C5C', cterm=246 },
  darker  = { gui='#4A3637', cterm=243 },
  darkest = { gui='#4A3637', cterm=240 },
  base    = { gui='#1f1f1f', cterm=235 },
  black   = { gui='#1f1f1f', cterm=234 },
  backgnd = { gui='#1f1f1f', cterm=233 },

  cactus  = { gui='#7b8748', cterm=108 }, -- limegreen
  grass   = { gui='#7b8748', cterm=108 }, -- limegreen
  fruit   = { gui='#d17b49', cterm=167 }, -- coralpink
  brick   = { gui='#d17b49', cterm=167 }, -- brickpink
  purple  = { gui='#775759', cterm=103 },
  cyan    = { gui='#6d715e', cterm=110 },
  red     = { gui='#d17b49', cterm=167 },
  orange  = { gui='#d7875f', cterm=173 },
  brown   = { gui='#af875f', cterm=137 },
  blue    = { gui='#535C5C', cterm=067 },
}
